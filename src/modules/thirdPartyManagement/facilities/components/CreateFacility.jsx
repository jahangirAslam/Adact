...
import { createFacility } from "../requests";
...
const CreateFacility = (props) => {
  ...
  return (
    <ModalComponent mainTitle="Create" subTitle="Facilitys" visible={ true } footer={ footer } onCancel={ () => props.onCreated(false) }>
      <Form
        layout="vertical"
        name={ formName }
        onFinish={ onFinish }
