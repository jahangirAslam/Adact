...
const CreateAgent = (props) => {
  ...
  return (
    <ModalComponent mainTitle="Create" subTitle="Agents" visible={ true } footer={ footer } onCancel={ () => props.onCreated(false) }>
      <Form
        layout="vertical"
        name={ formName }
        onFinish={ onFinish }
