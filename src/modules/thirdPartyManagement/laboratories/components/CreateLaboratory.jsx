...
import { createLaboratory } from "../requests";
import { getLocationDependencies } from "@mods/commons/locations/requests";

const formName = "createLaboratory";
...
const onDependencySuccess = (data, res) => {
  ...
  return (
    <ModalComponent mainTitle="Create" subTitle="Laboratory" visible={true} footer={footer} onCancel={() => props.onCreated(false)}>
      <Form
        layout="vertical"
        name={formName}
        onFinish={onFinish}
