...
import { createAllThirdParty } from "../requests";
import { getLocationDependencies } from "@mods/commons/locations/requests";

const formName = "createAllThirdParty";
const CreateAllThirdParty = (props) => {
...
const onDependencySuccess = (data, res) => {
  ...
  return (
    <ModalComponent mainTitle="Create" subTitle="All Third Party" visible={true} footer={footer} onCancel={() => props.onCreated(false)}>
      <Form
        layout="vertical"
        name={formName}
        onFinish={onFinish}
...
export default CreateAllThirdParty
