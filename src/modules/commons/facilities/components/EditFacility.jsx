...
import { getFacility, updateFacility, getFacilityDependencies } from "../requests";
import { useEffect } from "react";


const formName = "editFacility";
...
const EditFacility = (props) => {
    ...
    useEffect(() => {
        getSelectFieldsData();
        makeRequest(setLoader, getFacility, props.id, onFacilitySuccess, onFacilityError);
    ...
    const onFinish = (data) => {
        ...
        makeRequest(setLoader, updateFacility, payload, onSuccess, onError);
    }

    const onSuccess = (data, res) => {
        notify("Facility Updated", res.msg);
    ...
    return (
        <ModalComponent mainTitle="Update" subTitle="Facility" visible={ true } footer={ footer } onCancel={ () => props.onUpdated(false) }>
            <Form
                layout="vertical"
                name={ formName }
                onFinish={ onFinish }
