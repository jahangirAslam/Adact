...
import ViewTest from "./components/editProduct/labTest/components/viewTest/ViewTest";
...
const ProductRoutes = ({ match }) => (
  <Switch>
    ...
    <Route exact path={`${match.url}/product-test/edit/:id`} component={EditTest} />
    <Route exact path={`${match.url}/product-test/view/:id`} component={ViewTest} />
