...
import EditTemplateVariable from "./manageVariable/components/EditTemplateVariable";
import IndexManageVariable from "./manageVariable/indexManageVariable";
...
const Templates = ({ match }) => (
  <Switch>
    ...
    <Route exact path={`${match.url}/manage-template-variable`} component={IndexManageVariable} />
     <Route exact path={`${match.url}/manage-global-variable/edit/:id`} component={EditTemplateVariable} />
