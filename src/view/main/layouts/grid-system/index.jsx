...
export default function GridSystem() {
  return (
    <Row gutter={[32, 32]} className="da-mb-32">
      ...
      <Col span={24}>
        <Row className="da-grid-row-bg">
          <Col span={24} className="da-bg-primary-2 da-grid-col">
            %100
          </Col>
        </Row>
      </Col>
      ...
      <Col span={24}>
        <Row className="da-grid-row-bg">
          <Col span={6} className="da-bg-primary-2 da-grid-col">
            %25
          </Col>

          <Col
            span={6}
            className="da-bg-black-0 da-text-color-black-100 da-grid-col"
          >
            %25
          </Col>
      ...
      <Col span={24}>
        <Row className="da-grid-row-bg">
          <Col span={8} className="da-bg-primary-2 da-grid-col">
            %33.33
          </Col>
      ...
      <Col span={24}>
        <Row className="da-grid-row-bg">
          <Col span={12} className="da-bg-primary-2 da-grid-col">
            %50
          </Col>
      ...
      <Col span={24}>
        <Row className="da-grid-row-bg">
          <Col span={16} className="da-bg-primary-2 da-grid-col">
            %66.66
          </Col>
      ...
      <Col span={24} className="da-mark">
        <p className="da-my-16">
        ...
        <h2 className="da-mt-32 da-mb-16">Outline</h2>
        ...
        <p className="da-my-16">Following is a brief look at how it works:</p>

        <ul className="da-pl-0">
          <li>
            <p>
